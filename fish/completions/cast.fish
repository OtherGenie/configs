...
complete -c cast -n "__fish_cast_using_subcommand 4byte-decode" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c cast -n "__fish_cast_using_subcommand 4byte-decode" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c cast -n "__fish_cast_using_subcommand 4byte-decode" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c cast -n "__fish_cast_using_subcommand 4byte-decode" -s q -l quiet -d 'Do not print log messages'
complete -c cast -n "__fish_cast_using_subcommand 4byte-decode" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand 4byte-decode" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand 4d" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c cast -n "__fish_cast_using_subcommand 4d" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c cast -n "__fish_cast_using_subcommand 4d" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c cast -n "__fish_cast_using_subcommand 4d" -s q -l quiet -d 'Do not print log messages'
complete -c cast -n "__fish_cast_using_subcommand 4d" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand 4d" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand 4bd" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c cast -n "__fish_cast_using_subcommand 4bd" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c cast -n "__fish_cast_using_subcommand 4bd" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c cast -n "__fish_cast_using_subcommand 4bd" -s q -l quiet -d 'Do not print log messages'
complete -c cast -n "__fish_cast_using_subcommand 4bd" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand 4bd" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c cast -n "__fish_cast_using_subcommand storage" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c cast -n "__fish_cast_using_subcommand st" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c cast -n "__fish_cast_using_subcommand wallet; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c cast -n "__fish_cast_using_subcommand wallet; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c cast -n "__fish_cast_using_subcommand wallet; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c cast -n "__fish_cast_using_subcommand wallet; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -s q -l quiet -d 'Do not print log messages'
complete -c cast -n "__fish_cast_using_subcommand wallet; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand wallet; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -s h -l help -d 'Print help (see more with \'--help\')'
...
never\t'Force disable color output'"
complete -c cast -n "__fish_cast_using_subcommand w; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c cast -n "__fish_cast_using_subcommand w; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c cast -n "__fish_cast_using_subcommand w; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -s q -l quiet -d 'Do not print log messages'
complete -c cast -n "__fish_cast_using_subcommand w; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand w; and not __fish_seen_subcommand_from new n new-mnemonic nm vanity va address a addr sign s sign-auth sa verify v import i list ls private-key pk decrypt-keystore dk help" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c cast -n "__fish_cast_using_subcommand decode-eof" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c cast -n "__fish_cast_using_subcommand decode-eof" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c cast -n "__fish_cast_using_subcommand decode-eof" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c cast -n "__fish_cast_using_subcommand decode-eof" -s q -l quiet -d 'Do not print log messages'
complete -c cast -n "__fish_cast_using_subcommand decode-eof" -l json -d 'Format log messages as JSON'
complete -c cast -n "__fish_cast_using_subcommand decode-eof" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "max-int" -d 'Prints the maximum value of the given integer type'
...
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "format-units" -d 'Format a number from smallest unit to decimal with arbitrary decimals'
...
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "decode-calldata" -d 'Decode ABI-encoded input data'
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "decode-string" -d 'Decode ABI-encoded string'
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "decode-event" -d 'Decode event data'
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "decode-error" -d 'Decode custom error data'
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "decode-abi" -d 'Decode ABI-encoded input or output data'
...
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "codehash" -d 'Get the codehash for an account'
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "storage-root" -d 'Get the storage root for an account'
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "source" -d 'Get the source code of a contract from a block explorer'
...
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "creation-code" -d 'Download a contract creation code from Etherscan and RPC'
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "artifact" -d 'Generate an artifact file, that can be used to deploy a contract locally'
complete -c cast -n "__fish_cast_using_subcommand help; and not __fish_seen_subcommand_from max-int min-int max-uint address-zero hash-zero from-utf8 concat-hex from-bin to-hexdata to-check-sum-address to-ascii to-utf8 from-fixed-point to-bytes32 to-fixed-point to-uint256 to-int256 shl shr to-unit parse-units format-units to-wei from-wei to-rlp from-rlp to-hex to-dec to-base access-list logs block block-number call calldata chain chain-id client compute-address disassemble mktx namehash tx receipt send publish estimate decode-calldata decode-string decode-event decode-error decode-abi abi-encode index index-erc7201 implementation admin 4byte 4byte-decode 4byte-event upload-signature pretty-calldata age balance base-fee code codesize gas-price sig-event keccak hash-message resolve-name lookup-address storage proof nonce codehash storage-root source wallet creation-code artifact constructor-args interface bind sig create2 find-block completions generate-fig-spec run rpc format-bytes32-string parse-bytes32-string parse-bytes32-address decode-transaction selectors decode-eof help" -f -a "constructor-args" -d 'Display constructor arguments used for the contract initialization'
