...
complete -c forge -n "__fish_forge_using_subcommand test" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand t" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand script" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand coverage" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand bind" -l ethers -d 'Generate bindings for the `ethers` library, instead of `alloy` (removed)'
...
complete -c forge -n "__fish_forge_using_subcommand bind" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand build" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand b" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand compile" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand create" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand c" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand snapshot" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand s" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand config" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand co" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand inspect" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand in" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from collision" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand selectors; and __fish_seen_subcommand_from co" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from collision" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand se; and __fish_seen_subcommand_from co" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from init" -l config-location -d 'Specify the config location' -r -f -a "foundry\t'Store config inside the `foundry.toml` file'
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from install" -l config-location -d 'Specify the config location without prompting' -r -f -a "foundry\t'Store config inside the `foundry.toml` file'
soldeer\t'Store config inside the `soldeer.toml` file'"
...
complete -c forge -n "__fish_forge_using_subcommand soldeer; and __fish_seen_subcommand_from update" -l config-location -d 'Specify the config location without prompting' -r -f -a "foundry\t'Store config inside the `foundry.toml` file'
soldeer\t'Store config inside the `soldeer.toml` file'"
...
complete -c forge -n "__fish_forge_using_subcommand eip712" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
...
complete -c forge -n "__fish_forge_using_subcommand bind-json" -l eof -d 'Use EOF-enabled solc binary. Enables via-ir and sets EVM version to Prague. Requires Docker to be installed'
