...
function __fish_anvil_global_optspecs
	string join \n v/verbosity q/quiet json color= j/threads= p/port= a/accounts= balance= timestamp= m/mnemonic= mnemonic-random= mnemonic-seed-unsafe= derivation-path= hardfork= b/block-time= slots-in-an-epoch= config-out= no-mining mixed-mining host= order= init= state= s/state-interval= dump-state= preserve-historical-states load-state= ipc= prune-history= max-persisted-states= transaction-block-keeper= f/fork-url= fork-header= timeout= retries= fork-block-number= fork-transaction-hash= fork-retry-backoff= fork-chain-id= compute-units-per-second= no-rate-limit no-storage-caching gas-limit= disable-block-gas-limit code-size-limit= disable-code-size-limit gas-price= block-base-fee-per-gas= disable-min-priority-fee chain-id= steps-tracing disable-console-log auto-impersonate optimism disable-default-create2-deployer memory-limit= odyssey allow-origin= no-cors no-request-size-limit cache-path= h/help V/version
end
...
complete -c anvil -n "__fish_anvil_needs_command" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c anvil -n "__fish_anvil_needs_command" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
...
complete -c anvil -n "__fish_anvil_needs_command" -l config-out -d 'Writes output of `anvil` as json to user-specified file' -r -F
...
complete -c anvil -n "__fish_anvil_needs_command" -l cache-path -d 'Path to the cache directory where states are stored' -r -F
complete -c anvil -n "__fish_anvil_needs_command" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c anvil -n "__fish_anvil_needs_command" -s q -l quiet -d 'Do not print log messages'
complete -c anvil -n "__fish_anvil_needs_command" -l json -d 'Format log messages as JSON'
...
complete -c anvil -n "__fish_anvil_needs_command" -l preserve-historical-states -d 'Preserve historical state snapshots when dumping the state'
...
complete -c anvil -n "__fish_anvil_needs_command" -l disable-min-priority-fee -l no-priority-fee -d 'Disable the enforcement of a minimum suggested priority fee'
...
complete -c anvil -n "__fish_anvil_needs_command" -l auto-impersonate -l auto-unlock -d 'Enables automatic impersonation on startup. This allows any transaction sender to be simulated as different accounts, which is useful for testing contract behavior'
...
complete -c anvil -n "__fish_anvil_needs_command" -l odyssey -d 'Enable Odyssey features'
...
complete -c anvil -n "__fish_anvil_using_subcommand completions" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c anvil -n "__fish_anvil_using_subcommand completions" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c anvil -n "__fish_anvil_using_subcommand completions" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c anvil -n "__fish_anvil_using_subcommand completions" -s q -l quiet -d 'Do not print log messages'
complete -c anvil -n "__fish_anvil_using_subcommand completions" -l json -d 'Format log messages as JSON'
complete -c anvil -n "__fish_anvil_using_subcommand completions" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c anvil -n "__fish_anvil_using_subcommand com" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c anvil -n "__fish_anvil_using_subcommand com" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c anvil -n "__fish_anvil_using_subcommand com" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c anvil -n "__fish_anvil_using_subcommand com" -s q -l quiet -d 'Do not print log messages'
complete -c anvil -n "__fish_anvil_using_subcommand com" -l json -d 'Format log messages as JSON'
complete -c anvil -n "__fish_anvil_using_subcommand com" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c anvil -n "__fish_anvil_using_subcommand generate-fig-spec" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c anvil -n "__fish_anvil_using_subcommand generate-fig-spec" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c anvil -n "__fish_anvil_using_subcommand generate-fig-spec" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c anvil -n "__fish_anvil_using_subcommand generate-fig-spec" -s q -l quiet -d 'Do not print log messages'
complete -c anvil -n "__fish_anvil_using_subcommand generate-fig-spec" -l json -d 'Format log messages as JSON'
complete -c anvil -n "__fish_anvil_using_subcommand generate-fig-spec" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c anvil -n "__fish_anvil_using_subcommand fig" -l color -d 'The color of the log messages' -r -f -a "auto\t'Intelligently guess whether to use color output (default)'
always\t'Force color output'
never\t'Force disable color output'"
complete -c anvil -n "__fish_anvil_using_subcommand fig" -s j -l threads -l jobs -d 'Number of threads to use. Specifying 0 defaults to the number of logical cores' -r
complete -c anvil -n "__fish_anvil_using_subcommand fig" -s v -l verbosity -d 'Verbosity level of the log messages.'
complete -c anvil -n "__fish_anvil_using_subcommand fig" -s q -l quiet -d 'Do not print log messages'
complete -c anvil -n "__fish_anvil_using_subcommand fig" -l json -d 'Format log messages as JSON'
complete -c anvil -n "__fish_anvil_using_subcommand fig" -s h -l help -d 'Print help (see more with \'--help\')'
